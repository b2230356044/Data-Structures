...
private:
    ...
    std::string isleName;           // Name of the Isle player is currently at
...
public:
    ...
    std::string getIsleName();          // Isle name getter
    void setIsleName(std::string isleName); // Isle name setter
